...
So lets run 'BestSegVal' again with 'a','b' of the best result and for finetuning with 'MIN' and 'filter'. For MIN lets orientate at the areas and for filter lets select the samll MovingWindows of 3 and 5. Further in this run lets test some 'h' values too.
